...
'''
Function to output the map to the console. The console will display the character stored at each location as a 
10 X 10 Maze. The proper labels for The Maze as well as the row and column numbers are output
'''
def displayMaze(map):
    print("                THE MAZE")
    for i in range(0, 10):
